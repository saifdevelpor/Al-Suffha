(function () {
  ...
  function createPageHeroImages() {
    ...
    if (!image) return;
    const style = document.createElement('style');
    style.textContent = '.q-page-hero.q-visual-hero{position:relative;isolation:isolate;overflow:hidden;background:linear-gradient(90deg,#031b42ed,#062657c9),var(--page-hero-image) center/cover no-repeat}.q-page-hero.q-visual-hero:before{content:"";position:absolute;inset:0;z-index:-1;background:linear-gradient(90deg,#031b42b8,transparent 82%)}.q-page-hero.q-visual-hero h1{color:#fff}.q-page-hero.q-visual-hero .q-eyebrow{color:#dce9fb}.q-page-hero.q-visual-hero>div>p:not(.q-eyebrow){color:#e0e9f7}.q-page-hero.q-visual-hero .q-button{background:#fff;border-color:#fff;color:var(--navy)}.q-page-hero.q-visual-hero .q-button:hover{background:var(--silver);border-color:var(--silver)}@media(max-width:575px){.q-page-hero.q-visual-hero{background:linear-gradient(90deg,#031b42f2,#062657df),var(--page-hero-image) center/cover no-repeat}}';
    document.head.appendChild(style);
  ...
  function createWhatsAppButton() {
    ...
    button.href = 'https://wa.me/923272000339';
  ...
  function createPremiumFooter() {
    ...
    const style = document.createElement('style');
    style.textContent = '.premium-footer{margin-top:34px!important;padding:0!important;background:#03172f!important;border-top:4px solid #dfe7f5;color:#fff}.premium-footer .container:before{display:none!important}.premium-footer-inner{padding:45px 0 32px}.premium-footer-logo{display:block!important;width:104px;height:70px;object-fit:contain;margin:0 0 26px!important}.premium-footer h4{font:700 20px Playfair Display,serif;margin:0 0 19px;color:#fff}.premium-footer ul{margin:0;padding:0;list-style:none}.premium-footer li{margin:0 0 11px}.premium-footer li a{color:#c9d7eb;text-decoration:none;font-size:14px}.premium-footer li a:hover{color:#fff}.premium-footer li i{color:#dfe7f5;margin-right:11px}.footer-contact-line{display:flex;align-items:center;gap:12px;margin:0 0 14px;color:#d2def0;font-size:14px}.footer-contact-line i{display:grid;place-items:center;width:39px;height:39px;border:1px solid #6a7e9e;border-radius:10px;color:#dfe7f5;font-size:18px}.footer-social-title{margin:23px 0 11px;font-weight:700}.footer-socials{display:flex;gap:10px}.footer-socials a{display:grid;place-items:center;width:38px;height:38px;border-radius:50%;border:1px solid #7183a0;color:#dfe7f5;text-decoration:none}.footer-socials a:hover{background:#dfe7f5;border-color:#dfe7f5;color:#03172f}.premium-footer-bottom{border-top:1px solid #ffffff1c;padding:19px 0;color:#91a5c3;font-size:13px}@media(max-width:575px){.premium-footer-inner{padding:35px 0 24px}.premium-footer h4{margin-top:22px}.premium-footer{margin-top:20px!important}.premium-footer-logo{width:88px;height:58px;margin:0 0 20px!important}}';
    document.head.appendChild(style);
    footer.className = 'q-footer premium-footer';
    footer.innerHTML = '<div class="container premium-footer-inner"><img class="premium-footer-logo" src="assets/img/al-suffha-logo.png" alt="Al Suffha Quran Academy"><div class="row gy-4"><div class="col-6 col-lg-3"><h4>Quick Info</h4><ul><li><a href="courses.html"><i class="bi bi-arrow-right"></i>1-on-1 Online Classes</a></li><li><a href="trainers.html"><i class="bi bi-arrow-right"></i>Dedicated Teacher</a></li><li><a href="contact.html"><i class="bi bi-arrow-right"></i>Flexible Timings</a></li><li><a href="contact.html"><i class="bi bi-arrow-right"></i>Class Enquiry</a></li></ul></div><div class="col-6 col-lg-3"><h4>Our Courses</h4><ul><li><a href="course-details.html?course=qaida"><i class="bi bi-arrow-right"></i>Noorani Qaida</a></li><li><a href="course-details.html?course=reading"><i class="bi bi-arrow-right"></i>Quran Reading</a></li><li><a href="course-details.html?course=tajweed"><i class="bi bi-arrow-right"></i>Tajweed Course</a></li><li><a href="course-details.html?course=hifz"><i class="bi bi-arrow-right"></i>Hifz and Revision</a></li><li><a href="course-details.html?course=islamic"><i class="bi bi-arrow-right"></i>Islamic Studies</a></li></ul></div><div class="col-6 col-lg-3"><h4>Useful Links</h4><ul><li><a href="index.html"><i class="bi bi-arrow-right"></i>Home</a></li><li><a href="about.html"><i class="bi bi-arrow-right"></i>About Academy</a></li><li><a href="courses.html"><i class="bi bi-arrow-right"></i>All Courses</a></li><li><a href="pricing.html"><i class="bi bi-arrow-right"></i>Lesson Plans</a></li><li><a href="contact.html"><i class="bi bi-arrow-right"></i>Contact Us</a></li><li><a href="https://wa.me/923272000339"><i class="bi bi-arrow-right"></i>WhatsApp Support</a></li></ul></div><div class="col-12 col-lg-3"><h4>Contact Us</h4><div class="footer-contact-line"><i class="bi bi-envelope"></i><span>info@alsuffhaquranacademy.com</span></div><div class="footer-contact-line"><i class="bi bi-telephone"></i><span>0327 2000339</span></div><div class="footer-contact-line"><i class="bi bi-whatsapp"></i><span>WhatsApp us anytime</span></div><p class="footer-social-title">Connect With Us</p><div class="footer-socials"><a href="#" aria-label="Facebook"><i class="bi bi-facebook"></i></a><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a><a href="https://wa.me/923272000339" aria-label="WhatsApp"><i class="bi bi-whatsapp"></i></a><a href="#" aria-label="YouTube"><i class="bi bi-youtube"></i></a></div></div></div></div><div class="premium-footer-bottom"><div class="container">© 2026 Al Suffha Quran Academy. All rights reserved.</div></div>';
  }
  function createCourseExperience() {
    ...
    document.querySelector('main').innerHTML = '<section class="course-detail-hero"><div class="container"><div class="row align-items-center g-5"><div class="col-lg-6"><p class="q-eyebrow">' + course.tag + '</p><h1>' + course.title + '</h1><p>' + course.intro + '</p><a class="q-button" href="https://wa.me/923272000339">Enquire on WhatsApp <i class="bi bi-whatsapp"></i></a></div><div class="col-lg-6"><img src="' + course.image + '" alt="' + course.title + '"></div></div></div></section><section class="q-section"><div class="container"><div class="row g-4"><div class="col-md-4"><article class="course-info-card"><i class="bi bi-person-video3"></i><h3>Online one-to-one classes</h3><p>Personal teaching and direct feedback in every class.</p></article></div><div class="col-md-4"><article class="course-info-card"><i class="bi bi-clock"></i><h3>Flexible timing</h3><p>Discuss a schedule that works for your family.</p></article></div><div class="col-md-4"><article class="course-info-card"><i class="bi bi-book"></i><h3>Clear progress plan</h3><p>Revision and new learning at a comfortable pace.</p></article></div></div></div></section><section class="q-section q-soft"><div class="container"><div class="row align-items-center g-5"><div class="col-lg-6"><p class="q-eyebrow">WHAT YOU WILL LEARN</p><h2 class="section-title">A clear path through the course</h2><ul class="course-syllabus">' + course.items.map(item => '<li><i class="bi bi-check2-circle"></i>' + item + '</li>').join('') + '</ul></div><div class="col-lg-6"><div class="course-info-card"><i class="bi bi-people"></i><h3>Who is this course for?</h3><p>' + course.who + '</p><hr><h3>How to begin</h3><p>Send us a WhatsApp enquiry with the learner age and preferred timings. We will share paid lesson fee details and availability.</p></div></div></div></div></section><section class="q-section"><div class="container"><div class="course-detail-cta"><div class="row align-items-center g-3"><div class="col-lg-8"><p class="q-eyebrow">READY TO START?</p><h2>Begin ' + course.title + ' online.</h2><p>Ask us about available timings and paid lesson fee details.</p></div><div class="col-lg-4 text-lg-end"><a class="q-button q-button-light" href="https://wa.me/923272000339">WhatsApp us now</a></div></div></div></div></section>';
  }
